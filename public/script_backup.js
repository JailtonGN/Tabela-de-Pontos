...
function salvarDados() {
    ...
    // Dados salvos - sincronização removida temporariamente
}
    ...
    filhos.forEach(filho => {
        ...
        filhoItem.innerHTML = `
            ...
            <div class="filho-acoes">
                <button onclick="editarFilho(${filho.id})" class="btn-edit">✏️ Editar</button>
                <button onclick="removerFilho(${filho.id})" class="btn-delete">🗑️ Remover</button>
            </div>
        `;
...
function salvarConfiguracoes() {
    // Salvar dados já é feito automaticamente pelas outras funções
    salvarDados();
